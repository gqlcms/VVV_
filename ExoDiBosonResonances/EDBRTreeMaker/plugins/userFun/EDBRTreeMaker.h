...
private:
    ...
    void HLTStore( edm::Handle<edm::TriggerResults> );
    void GENStore(edm::Handle<edm::View<reco::GenParticle> > , bool , edm::Handle<edm::View<pat::Muon>> , edm::Handle<edm::View<pat::Electron>> );
    void PuppiAK8_Store( double );
    void MET_Store( edm::Event const & );
    void EDBR_Debug();
...
void
EDBRTreeMaker::EDBR_Debug() {


    std::cout << "EDBRTreeMaker MET variable..." << std::endl;
    std::cout << "to check MetHandle : ptVlepJEC_new ...: " << ptVlepJEC_new << std::endl;
    std::cout << "EDBRTreeMaker Gen variable ..." << std::endl;
    std::cout << "to check Gen : massgenwf ...: " << massgenwf[0] << std::endl;
    std::cout << "EDBRTreeMaker filter variable ..." << std::endl;
    std::cout << "to check hlt : HLT_Ele2 ...: " << HLT_Ele2 << std::endl;
    std::cout << "EDBRTreeMaker jet variable ..." << std::endl;
