...
void
EDBRTreeMaker::GENStore(edm::Handle<edm::View<reco::GenParticle> > genParticles, bool RunOnMC_, edm::Handle<edm::View<pat::Muon>> mus, edm::Handle<edm::View<pat::Electron>> eles ){
